...
public class DRSListData implements Serializable {
    ...
    private String di_length;
    private String di_width;
    private String di_height;
    private String di_weight;
    ...
    public String getDi_length() {
        return di_length;
    }

    public String getDi_width() {
        return di_width;
    }

    public String getDi_height() {
        return di_height;
    }

    public String getDi_weight() {
        return di_weight;
    }
    ...
    public void setNo_of_parcel( String no_of_parcel ) {
        this.no_of_parcel = no_of_parcel;
    }

    public void setDi_length( String di_length ) {
        this.di_length = di_length;
    }

    public void setDi_width( String di_width ) {
        this.di_width = di_width;
    }

    public void setDi_height( String di_height ) {
        this.di_height = di_height;
    }

    public void setDi_weight( String di_weight ) {
